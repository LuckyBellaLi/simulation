...
This code is specificly for ISDM for PCRM.

This code is in python language, you can use any Python complier (e.g, Spyder) to run it. 

By default, you don't need to change anything, and directly run the code to get results for ISDM.
...
for r in range(0,replication): 
    ...
    for i in range(0,batch):
        for j in range(0,m1):  #this for loop use ISDM to generate quantile and mean estimators  
